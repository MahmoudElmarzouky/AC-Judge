...
namespace GraduationProject.Controllers.Group
{
    ...
    public class GroupController : Controller
    {
        ...
        private CreateGroupModel getCreateModelFromGroup(GraduationProject.Data.Models.Group group)
        {
            ...
            var model = new CreateGroupModel { GroupId = group.GroupId, GroupTitle = group.GroupTitle, GroupDescription = group.GroupDescription, Password = group.Password , Visable = group.Visable, OwnerId = ID};
            return model;
        }
